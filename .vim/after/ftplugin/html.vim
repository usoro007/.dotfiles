...
let g:user_emmet_mode='n' "Commonly added to start emmet in normal mode only
" let g:user_emmet_leader_key='j' "Commonly added to start emmet with 'jj'

nnoremap <buffer> <f9> :w<cr> :!python3 -m http.server 8000<cr>
